<?php
  ...
  $total_query = "SELECT COUNT(*) as total FROM contact_us_tb";
  ...
  $stmt = $conn->prepare("SELECT * FROM contact_us_tb ORDER BY id DESC LIMIT ? OFFSET ?");
...
<head>
    ...
    <title>All Contacts - Mzehemen U Tiv</title>
    <style>
